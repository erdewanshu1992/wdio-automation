describe('Simulate New Tab Handling on iOS Safari', () => {
  it('should simulate opening a new tab by navigating and going back', async () => {
    // Step 1: Open main page
    await browser.url('https://google.com');
    console.log('Opened Google on iOS Safari');
...
// npx cross-env PLATFORM=ios wdio run wdio.conf.enhanced.js --spec ./test/specs/ios-mobile-web/open-new-tab.test.spec.js
